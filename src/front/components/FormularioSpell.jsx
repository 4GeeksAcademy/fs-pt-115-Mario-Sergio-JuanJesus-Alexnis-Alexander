...
export const FormularioSpell = () => {
    ...
    return (
        <div className="container col-md-6 my-5 basic-form position-relative">
            ...
            <form className="row fw-bold" onSubmit={handleOnSubmit} >
                ...
                <div className="col-md-4 mb-3">
                    ...
                    <div class="checkbox-wrapper-26">
                        <input onChange={handleOnChange} type="checkbox" id="_checkbox-26" name="ritual_spell" />
                ...
                <div className="col-md-4 mb-3">
                    ...
                    <div class="checkbox-wrapper-26">
                        <input onChange={handleOnChange} type="checkbox" id="_checkbox-27" name="at_higher_levels" />
