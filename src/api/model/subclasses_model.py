...
class Subclasses(db.Model):
    ...
    spellcasting_ability: Mapped[Optional[str]] = mapped_column(String(255))
    can_cast_spells: Mapped[Optional[str]]= mapped_column(String(255))
    additional_spell_list: Mapped[Optional[str]] = mapped_column(String(255))
    spell_prepare_type: Mapped[Optional[str]] = mapped_column(String(255))
    knows_all_spells: Mapped[Optional[str]] = mapped_column(String(255))
    spell_learning_style: Mapped[Optional[str]] = mapped_column(String(255))
    additional_specific_spells: Mapped[Optional[str]] = mapped_column(String(255))
