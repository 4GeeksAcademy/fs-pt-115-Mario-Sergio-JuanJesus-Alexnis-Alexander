...
class Background(db.Model):
    ...
    feats_description: Mapped[str] = mapped_column(Text)
    skill_proficiencies_description: Mapped[str] = mapped_column(Text)
    tool_proficiencies_description: Mapped[str] = mapped_column(Text)
    languages_description: Mapped[str] = mapped_column(Text)
    equipment_description: Mapped[str] = mapped_column(Text)
    specific_table_name: Mapped[str] = mapped_column(String(255))
    specific_tabla_desc: Mapped[str] = mapped_column(Text)
    feature: Mapped[str] = mapped_column(String(255))
    feature_desc: Mapped[str] = mapped_column(Text)
    variant: Mapped[str] = mapped_column(String(255))
    variant_desc: Mapped[str] = mapped_column(Text)
    variant_feature: Mapped[str] = mapped_column(String(255))
    variant_feature_desc: Mapped[str] = mapped_column(Text)
    suggested_characteristics: Mapped[str] = mapped_column(Text)
    spell_list_introduction: Mapped[str] = mapped_column(Text)
